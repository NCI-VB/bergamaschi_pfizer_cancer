---
title: "DEG and Volcano Plots (No Low)"
...
```{r deg, echo=TRUE}
  ...
  targetfile <- targetfile[!targetfile$sample_id %in% low_samples, ]
  ...
  write.table(deg_results, file=file.path(workDir,"output","deg_analysis_no_low.tsv"), sep="\t", row.names = FALSE)
